...
function runThemeTokenTests() {
  console.log('🧪 Running Phase 1 Cormorant Garamond & Rich Atlas Visual Tests...');
  let passed = 0;
  let failed = 0;
  ...
  // 1. Verify Default Watercolor Atlas Theme Preset, Cormorant Garamond & Landmass Assets
  ...
  assert(watercolor.paperTextureUrl === '/branding/watercolor-parchment-base.webp', 'paperTextureUrl is official parchment asset');
  ...
  assert(themePresets.midnight_ocean.sidebarEdgeStyle === 'simple-border', 'Midnight Ocean uses simple border');
